...
st.info(
    ...
    <div style='line-height:1.5'>
        <b>Data Integrity Is Our Foundation</b><br>
        At every step—from file upload to final report—we enforce strict validation to guarantee your visitor data is accurate, complete, and compliant.<br>
        ...
        <br><br>
        <b>Why is Data Integrity Important?</b><br>
        • <b>Accuracy:</b> Correct visitor details reduce clearance delays.<br>
        • <b>Security:</b> Reliable ID checks prevent unauthorized access.<br>
        • <b>Compliance:</b> Audit-ready records ensure regulatory adherence.<br>
        • <b>Efficiency:</b> Trustworthy data powers faster reporting and analytics.
    </div>
    """,
